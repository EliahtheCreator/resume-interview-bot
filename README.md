...
一个给求职者使用的 AI 岗面试资料库与语音练习 MVP。用户可以先查看岗位面试资料、答题框架和备考清单，再选择岗位、上传 PDF 简历，用语音完成自我介绍、5 道业务问题、最多一次追问和到岗安排确认，最后得到加权评分报告。
...
- 三个首发岗位的面试资料库：高频问题、回答框架、强回答信号、常见扣分点和备考清单
- 不限制练习次数
- PDF 简历上传与文本提取
- 扫描版 PDF 的本地 OCR 兜底
- 浏览器语音识别，每题最多 2 分钟
